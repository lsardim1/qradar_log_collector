...
ARIEL_MAX_RESULTS = 50000           # Limite máximo de resultados por página AQL
...
class QRadarClient:
    ...
    def run_aql_query(self, aql: str) -> Optional[List[Dict]]:
        ...
        # Buscar resultados com paginação automática para ambientes com muitos log sources
        try:
            all_events: List[Dict] = []
            offset = 0
            page_size = ARIEL_MAX_RESULTS
            while True:
